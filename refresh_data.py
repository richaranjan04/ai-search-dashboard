...
BUCKET_RULES = [
    ...
    ('Search & Virtual Agent', [
        ('full', r'\b(virtual agent|genius result|genius results|now assist.*va|'
                 r'va.*now assist|nlu.*search|search.*nlu)\b'),
        ('full', r'\bnow assist\b.{0,80}\b(virtual agent|genius|va search|agent workspace)\b'),
        ('full', r'\b(genius)\b.{0,60}\b(result|search|format|display)\b'),
    ]),
    ('Search Analytics', [
...
MANUAL_OVERRIDES = {
    ...
    # Search & Virtual Agent
    'CS9204319': 'Search & Virtual Agent',
    'CS9090732': 'Search & Virtual Agent',
    'CS9263984': 'Search & Virtual Agent',
    'CS9236667': 'Search & Virtual Agent',
    'CS9036117': 'Search & Virtual Agent',
    'CS9268761': 'Search & Virtual Agent',
    'CS9175693': 'Search & Virtual Agent',
    'CS9085874': 'Search & Virtual Agent',
    'CS9076505': 'Search & Virtual Agent',
    'CS9134432': 'Search & Virtual Agent',
    'CS9241294': 'Search & Virtual Agent',
    # Security & Access
    ...
    'CS9113432': 'Others',
    'CS9227608': 'Search & Virtual Agent',
    # Others
    'CS9081282': 'Others',
    'CS9030255': 'Others',
    'CS9277153': 'Others',
    ...
    'CS9073118': 'Search & Virtual Agent',
    'CS9120491': 'Others',
